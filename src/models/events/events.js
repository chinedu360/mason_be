...
module.exports = class Events {
  constructor(event_name, event_date, description, images) {
  ...
  async save() {
    try {
      const result = await db.execute(
        "INSERT INTO Events (event_name, event_date, description, images) VALUES (?, ?, ?, ?)",
        [this.event_name, this.event_date, this.description, this.images]
      );
